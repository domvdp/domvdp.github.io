...
mathjax: "true"
---
To view more, see my [GitHub Repository](https://github.com/domvdp/Uber-Trip-Analysis)
...
- <a href="#nav1">1) Histogram: Busiest Days for Uber</a>
- <a href="#nav2">2) ...</a>
- <a href="#nav3">3) ...</a>
- <a href="#nav4">4) ...</a>
- <a href="#nav5">5) ...</a>
