...
The written code for this project has been embedded: <br/>
...
**NOTE** - The notebooks for each month all follow the same structure; only minor changes were made for each month of data.
