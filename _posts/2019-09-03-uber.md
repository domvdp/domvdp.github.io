...
I've embedded my written code from Jupyter Notebooks in front of the conclusion section of this project. To
view this code immediately, click the following link: <a href="#code">Orginal Code (Jupyter Notebooks)</a>
...
The notebooks for each month all follow the same structure; only minor changes were made for each month of data.1`
