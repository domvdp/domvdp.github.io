...
mathjax: "true"
---
I welcome anyone to copy, manipulate or use this analysis. You can view all of the project files in my [GitHub Repository](https://github.com/domvdp/Uber-Trip-Analysis)
...
- <a href="#nav1">1) Day of Month Histograms (red): Busiest Days of Each Month</a>
- <a href="#nav2">2) Day of Month Linegraphs: Sorting From Least to Most Busy Days for Each Month</a>
- <a href="#nav3">3) Day of Week Histograms (green): Busiest Days of the Week for Each Month</a>
- <a href="#nav4">4) Hour of Day Histograms (blue): Busiest Hours of Day and Night for Each Month</a>
- <a href="#nav5">5) Time and Day Heatmaps: Overall Most Popular Time and Day for Each Month</a>
- <a href="#nav6">6) Latitude and Longitude Maps: Most Popular Areas for Each Month (View of Manhattan)</a>
...
------------------------------------------------------------------------------->
<a name="nav1"></a>
# 1) Day of Month Histograms: Busiest Days of Each Month for Uber
...
------------------------------------------------------------------------------->
<a name="nav2"></a>
# 2) Day of Month Linegraphs: Sorting From Least to Most Busy Days for Each Month
...
------------------------------------------------------------------------------->
<a name="nav3"></a>
# 3) Day of Week Histograms: Busiest Days of the Week for Each Month
...
------------------------------------------------------------------------------->
<a name="nav4"></a>
# 4) Hour of Day Histograms (blue): Busiest Hours of Day and Night for Each Month
...
------------------------------------------------------------------------------->
<a name="nav5"></a>
# 5) Time and Day Heatmaps: Overall Most Popular Time and Day for Each Month
...
------------------------------------------------------------------------------->
<a name="nav6"></a>
# 6) Latitude and Longitude Maps: Most Popular Areas for Each Month (View of Manhattan)
